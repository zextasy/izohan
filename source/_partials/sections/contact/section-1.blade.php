<section class="flex flex-col md:flex-row mx-auto max-w-screen-xl pt-12 pb-2">
    <div class="md:w-2/3 px-4 flex flex-col justify-center">
        <div class="lg:text-center">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-black md:text-5xl lg:text-6xl">
                Contact Us
            </h1>
            <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                Looking for clarity, collaboration or a custom solution? <br>
                Strart the conversation today
            </p>
        </div>
