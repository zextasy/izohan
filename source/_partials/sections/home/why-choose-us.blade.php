<div class="bg-white">
    <section id="features" class="relative block px-6 py-10 md:py-20 md:px-10">
        <div class="mx-auto text-center">
            <p class="mx-auto text-izo-purple text-2xl mb-5">Why Choose Us</p>
            <p class="mx-auto text-4xl font-semibold">Designed for Flexibility. Driven by Innovation.</p>
            <p class="mx-auto max-w-md">Our team combines deep technical expertise with proven industry experience,
                delivering
                actionable insights and tailored solutions that protect your business, drive compliance, and enable
                growth.</p>
        </div>
