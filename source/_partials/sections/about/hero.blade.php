<section class="relative bg-gradient-to-br from-blue-900 to-indigo-800 text-white overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="w-full md:w-1/2 mb-12 md:mb-0">
                        ...
                        <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                            <a href="/contact" class="bg-amber-500 text-blue-900 font-semibold px-8 py-3 rounded-full hover:bg-amber-100 transition duration-300 text-center">Contact Us</a>
                            <a href="/services" class="border-2 border-amber-500 text-amber-500 font-semibold px-8 py-3 rounded-full hover:bg-amber-500 hover:text-blue-900 transition duration-300 text-center">Our Services</a>
                        </div>
                    </div>
                    ...
                    <div class="w-full md:w-1/2 md:pl-12">
                        <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-2xl">
                            <h2 class="text-2xl font-semibold mb-6">Why IZOHAN SOLUTIONS?</h2>
                            <ul class="space-y-4">
            ...
            <div class="absolute bottom-0 left-0 right-0">
                <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 120L60 105C120 90 240 60 360 45C480 30 600 30 720 37.5C840 45 960 60 1080 67.5C1200 75 1320 75 1380 75L1440 75V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0Z" fill="orange"/>
                </svg>
            </div>
</section>