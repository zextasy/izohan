...
<nav
    ...
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <!-- Mobile Menu Button -->
        <button id="menu-btn" class="block md:hidden flex items-center text-gray-700">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#000000"
                class="w-6 h-6">
